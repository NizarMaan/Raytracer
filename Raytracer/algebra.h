...
public:
  ...
  //new constructor added by me (nizar maan)
...
//setting up Line3D class
class Line3D{
public:
    Line3D();
    ~Line3D();
    Line3D(const Point3D &p1, Point3D &Point2D);
